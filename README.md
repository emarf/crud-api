...
Before starting the server, rename the `.env.example` file to `.env`. The server will run on port 3000 by default, but you can modify the `.env` file if you need a different port or other configuration settings.

### Run in Development Mode

To start the application in development mode, open your terminal and run:
